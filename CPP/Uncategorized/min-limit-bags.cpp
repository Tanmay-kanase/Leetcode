...
int main(){
    cout << "Program for minimum balls in the bag " << endl;
    Solution s;
    int maxO;
    cout << "Enter the maximum operations : " << endl;
    cin >> maxO;
    vector<int> nums = {12 , 22, 44, };
    cout << "Minimum size is : " << s.minimumSize(nums , maxO);
